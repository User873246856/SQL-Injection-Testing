...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action'])) {
    // Use item ID from POST, which is the menu item ID
    ...
    if ((isset($_SESSION['cart']['Box of Popcorn']) || isset($_SESSION['cart']['Nachos']) || isset($_SESSION['cart']['Hot Dog'])) && isset($_SESSION['cart']['Pepsi Max (Reg)'])) {
        echo "<script>
...
<head>
    ...
    <title>Projection Room - Food & Drink Menu</title>
    <link rel="stylesheet" type="text/css" href="stylesheets/food_drink.css">
</head>
<body>
    <header>
        <h1>Projection Room - Food & Drink Menu</h1>
        <nav>
            <ul>
